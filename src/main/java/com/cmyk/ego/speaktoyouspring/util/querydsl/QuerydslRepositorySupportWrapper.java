...
/// QueryDSL을 쉽게 사용하기 위한 공통 지원 클래스
///
/// QueryDSL 기반으로 Entity를 조회, 삭제, 업데이트할 수 있는 기능 제공.
/// EntityManager와 QueryDSL 객체를 관리하고, 기본적인 JPQLQuery, DeleteClause, UpdateClause 제공.
@Repository
